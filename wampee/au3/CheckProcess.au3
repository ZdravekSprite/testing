...
$mariadb_pid =ProcessExists($mariadb_proc_name)

If $apache_pid = 0 Then
	$TrayIconNoneRunning=18
ElseIf $apache_pid <> 0 And $mysql_pid <> 0 Then
	$TrayIconNoneRunning=16
ElseIf $apache_pid <> 0 And $mariadb_pid <> 0 Then
	$TrayIconNoneRunning=16
ElseIf $apache_pid = 0 And $mysql_pid = 0  And $mariadb_pid = 0 Then
	$TrayIconNoneRunning=18
Else
