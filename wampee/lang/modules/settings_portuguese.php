...
$w_testPortMysql = 'Testar porta MySQL';
$w_testPortMysqlUsed = 'Testar porta usada pelo MySQL: ';
$w_enterPort = 'Digite o nњmero da porta desejada';

// Right-click Settings
$w_wampSettings = 'Opчѕes do Wamp';
...
$w_settings['ItemServicesNames'] = 'Mostrar em Ferramentas: alterar nomes dos serviчos';

// Right-click Tools
$w_wampTools = 'Ferramentas';
$w_restartDNS = 'Reiniciar DNS';
$w_testConf = 'Verificar sintaxe em httpd.conf';
$w_testServices = 'Verificar estado dos serviчos';
$w_changeServices = 'Mude os nomes de serviчos';
$w_enterServiceNameApache = "Insira um nњmero de эndice para o serviчo Apache. Ele serс adicionado a 'wampapache'";
$w_enterServiceNameMysql = "Insira um nњmero de эndice para o serviчo de Mysql. Ele serс adicionado a 'wampmysqld'";
...
$w_apacheLoadedModules = 'Mostrar Extensѕes Carregadas do Apache';
$w_empty = 'Limpar';
$w_emptyAll = 'Limpar Todos os';
$w_dnsorder = 'Verifique ordem de pesquisa DNS';

//miscellaneous
$w_ext_spec = 'Extensѕes Especiais';
$w_phpparam_info = 'Apenas para informaчуo';
$w_ext_nodll = 'Sem arquivo dll';
$w_ext_noline = "Sem 'extension='";
$w_mod_fixed = "Mѓdulo Irreversэvel";
