...
$w_testPortMysql = 'Έλεγχος θύρας MySQL';
$w_testPortMysqlUsed = 'Έλεγχος θύρας MySQL σε χρήση:';
$w_enterPort = 'Εισάγετε τον επιθυμητό αριθμό θύρας';

// Right-click Settings
$w_wampSettings = 'Ρυθμίσεις Wamp';
$w_settings['urlAddLocalhost'] = 'Προσθήκη του localhost στο url';
$w_settings['VirtualHostSubMenu'] = 'Υπομενού VirtualHosts';
$w_settings['ProjectSubMenu'] = 'Υπομενού έργων';
$w_settings['HomepageAtStartup'] = '’νοιγμα Αρχικής Wampserver με την εκκίνηση';
$w_settings['MenuItemOnline'] = 'Αντικείμενο Μενού: Σε λειτουργία / Εκτός λειτουργίας';
$w_settings['ItemServicesNames'] = 'Αντικείμενο Μενού Εργαλείων: Αλλαγή ονομάτων υπηρεσιών';
...
$w_enterServiceNameApache = "Εισάγετε έναν αριθμό ευρετηρίου για την υπηρεσία Apache. Θα προστεθεί στο «wampapache»";
$w_enterServiceNameMysql = "Εισάγετε έναν αριθμό ευρετηρίου για την υπηρεσία Mysql. Θα προστεθεί στο «wampmysqld»";
$w_compilerVersions = 'Έλεγχος Μεταφραστή VC, συμβατότητας και αρχείων ini';
$w_UseAlternatePort = 'Χρήση μιας θύρας διαφορετικής από την %s';
