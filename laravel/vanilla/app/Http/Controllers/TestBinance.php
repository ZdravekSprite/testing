...
class TestBinance extends Controller
{
  ...
  public function sell_targets()
  {
    ...
    //$sells[] = (new $this)->sell("ADABUSD", 1.4, 7.143, "sell_ada00");
    //$sells[] = (new $this)->sell("ADABUSD", 4.6, 2.174, "sell_ada01");
    //$sells[] = (new $this)->sell("ADABUSD", 4.7, 2.128, "sell_ada02");
    ...
    //$sells[] = (new $this)->sell("LUNABUSD", 0.45, 57.5, "sell_luna00");
    //$sells[] = (new $this)->sell("LUNABUSD", 0.19, 53.19, "sell_luna01");
