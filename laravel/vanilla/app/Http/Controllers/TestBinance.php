...
class TestBinance extends Controller
{
  ...
  public function sell_targets()
  {
    ...
    //$sells[] = (new $this)->sell("BNBBUSD", 0.08, 545.2, "sell_bnb02");
    //$sells[] = (new $this)->sell("BNBBUSD", 0.02, 512.1, "sell_bnb01");
    //$sells[] = (new $this)->sell("ADABUSD", 36.6, 3.273, "sell_ada02");
    //$sells[] = (new $this)->sell("ADABUSD", 3.9, 2.579, "sell_ada01");
    //$sells[] = (new $this)->sell("ADABUSD", 7.15, 1.3996, "sell_ada_quick");
    //$sells[] = (new $this)->sell("MATICBUSD", 31.9, 1.76, "sell_matic02");
    //$sells[] = (new $this)->sell("MATICBUSD", 6.1, 1.659, "sell_matic01");
    //$sells[] = (new $this)->sell("SOLBUSD", 0.37, 226.58, "sell_sol02");
    //$sells[] = (new $this)->sell("SOLBUSD", 0.06, 177.7, "sell_sol01");
    $sells[] = (new $this)->sell("LUNABUSD", 0.85, 56.37, "sell_luna02");
    $sells[] = (new $this)->sell("LUNABUSD", 0.22, 45.95, "sell_luna01");
    //$sells[] = (new $this)->sell("FTTBUSD", 0.88, 86,75, "sell_ftt02");
    //$sells[] = (new $this)->sell("FTTBUSD", 0.15, 66.87, "sell_ftt01");
