...
class TestBinance extends Controller
{
  ...
  public function sell_targets()
  {
    ...
    //$sells[] = (new $this)->sell("BNBBUSD", 0.061, 562.6, "sell_bnb00");
    //$sells[] = (new $this)->sell("BNBBUSD", 0.019, 528.4, "sell_bnb01");
    //$sells[] = (new $this)->sell("BNBBUSD", 0.02, 512.1, "sell_bnb02");
    //$sells[] = (new $this)->sell("ADABUSD", 7.9, 4.11, "sell_ada00");
    //$sells[] = (new $this)->sell("ADABUSD", 3.7, 2.709, "sell_ada01");
    //$sells[] = (new $this)->sell("ADABUSD", 3.9, 2.579, "sell_ada02");
    //$sells[] = (new $this)->sell("ADABUSD", 7.15, 1.3996, "sell_ada_quick");
    //$sells[] = (new $this)->sell("MATICBUSD", 20.3, 1.868, "sell_matic00");
    //$sells[] = (new $this)->sell("MATICBUSD", 5.7, 1.761, "sell_matic01");
    //$sells[] = (new $this)->sell("MATICBUSD", 5.9, 1.709, "sell_matic02");
    //$sells[] = (new $this)->sell("SOLBUSD", 0.15, 243.79, "sell_sol00");
    //$sells[] = (new $this)->sell("SOLBUSD", 0.05, 228.43, "sell_sol01");
    //$sells[] = (new $this)->sell("SOLBUSD", 0.05, 220.38, "sell_sol02");
    //$sells[] = (new $this)->sell("LUNABUSD", 0.85, 56.37, "sell_luna02");
    //$sells[] = (new $this)->sell("LUNABUSD", 0.22, 45.95, "sell_luna01");
  ...
  public function buy_targets()
  {
    ...
    //$buys[] = (new $this)->buy("EURBUSD", 8.7, 1.150, "buy_eur01");
    //$buys[] = (new $this)->buy("EURBUSD", 8.8, 1.149, "buy_eur02");
    //dd($buys);
    return $buys;
  }
