          ...
          <div class="max-w-xl">
            <form method="post" action="{{ route('settings.update') }}" class="mt-6 space-y-6">
              ...
              <div>
                ...
                <input id="start1" type="time" name="start1" value="{{ $settings && $settings->start1 ? $settings->start1->format('H:i') : old('start1')?? '06:00'}}" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" />
                <x-p>Vrijeme kada započinje 1. smjena.</x-p>
                <x-label for="end1" :value="__('Kraj')" />
                <input id="end1" type="time" name="end1" value="{{ $settings && $settings->end1 ? $settings->end1->format('H:i') : old('end1')?? '14:00'}}" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" />
              ...
              <div>
                ...
                <input id="start2" type="time" name="start2" value="{{ $settings && $settings->start2 ? $settings->start2->format('H:i') : old('start2')?? '14:00'}}" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" />
                <x-p>Vrijeme kada započinje 2. smjena.</x-p>
                <x-label for="end2" :value="__('Kraj')" />
                <input id="end2" type="time" name="end2" value="{{ $settings && $settings->end2 ? $settings->end2->format('H:i') : old('end2')?? '22:00'}}" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" />
              ...
              <div>
                ...
                <input id="start3" type="time" name="start3" value="{{ $settings && $settings->start3 ? $settings->start3->format('H:i') : old('start3')?? '22:00'}}" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" />
                <x-p>Vrijeme kada započinje 3. smjena.</x-p>
                <x-label for="end2" :value="__('Kraj')" />
                <input id="end3" type="time" name="end3" value="{{ $settings && $settings->end3 ? $settings->end3->format('H:i') : old('end3')?? '06:00'}}" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" />
