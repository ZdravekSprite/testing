  ...
  <div class="py-12">
          ...
          <table class="table-auto w-full">
            ...
            <tbody>
              ...
              <tr>
                ...
                @if(isset($day->sick))
                <td>
                  <div class="w-full rounded-md relative bg-indigo-100" style="min-height: 18px;" title={{$day->date->format('d.m.Y')}}>
    ...
    document.getElementById('delete-form-{{ $day->date->format('d.m.Y') }}').submit();" title="Izbriši">
                ...
                <td>
                  ...
                  <a class="float-left ml-1" href="{{ route('days.create', ['date' => $day->date->format('d.m.Y'), 'start' => '06:00']) }}" title="1.smjena">
                  ...
                  <a class="float-left ml-1" href="{{ route('days.create', ['date' => $day->date->format('d.m.Y'), 'start' => '14:00']) }}" title="2.smjena">
