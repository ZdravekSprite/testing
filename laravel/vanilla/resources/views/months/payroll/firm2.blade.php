          <tbody>
            ...
            @if($data['1.2.kn'] != '0,00')
            <tr>
              <td class="w-3/4 border p-2 pl-6" colspan="2">1.2. sati redovnog rada noću</td>
            ...
            @if($data['1.9.kn'] != '0,00')
            <tr>
              <td class="w-3/4 border p-2 pl-6" colspan="2">1.9 sati redovitog rada nedelja + drž.praznikom/blagdanom</td>
              <td class="w-1/8 border p-2 text-center">{{ $data['1.9.h'] }}</td>
              <td class="w-1/8 border p-2 text-right">{{ $data['1.9.kn'] }}</td>
            </tr>
            @endif
