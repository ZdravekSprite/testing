                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="flex-shrink-0 flex items-center">
                                <inertia-link :href="'/'">
                                    <sprite-application-mark class="block h-9 w-auto" />
                                </inertia-link>
                            </div>
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <jet-nav-link :href="route('platnalista')" :active="route().current('platnalista')">
                                    Platna lista
                                </jet-nav-link>
                            </div>
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <jet-nav-link :href="route('radnisati')" :active="route().current('radnisati')">
                                    Radni sati
                                </jet-nav-link>
                            </div>
                        </div>
...
<script>
    import SpriteApplicationMark from '@/Sprite/ApplicationMark'
